...
for i in range(S):
        ...
        total_Distance += dist(last, next_loc)  # total distance #bir önceki,next_loc gideceği location
        ...
        if (tk - total_Distance >= 0 and cap-totalMilk >= 0):
            ...
            mask[next_loc] = True
            totalMilk -= milk(next_loc-1) # bir sonraki seçeceği marketin süt miktarını toplam süt miktarından çıkar
